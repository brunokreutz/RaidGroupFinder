        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        result2 = await _userManager.AddLoginAsync(user, info2);
                        if (result2.Succeeded)
                        {
                            _logger.LogInformation("User created an account using {Name} provider.", info2.LoginProvider);
                ...
                ProviderDisplayName = info2.ProviderDisplayName;
                ReturnUrl = returnUrl;
                return Page();
            }
        }
